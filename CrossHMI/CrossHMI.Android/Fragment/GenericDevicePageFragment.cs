        ...
        protected override void InitBindings()
        {
            Bindings.Add(this.SetBinding(() => ViewModel.Device).WhenSourceChanges(() =>
            {
                ...
                PropertiesRecyclerView.SetAdapter(
                    new ObservableRecyclerAdapter<string, PropertyViewHolder>(ViewModel.Device.PropertiesNames, DataTemplate,
                        ItemTemplate, HolderFactory){ApplyLayoutParams = true});
